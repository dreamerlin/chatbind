...
from chatbind import LlavaLlamaImageBindSelectAllForCausalLM
from chatbind.conversation import conv_templates
...
def eval_model(args):
    ...
    if args.mm_projector is None:
        ...
        model = LlavaLlamaImageBindSelectAllForCausalLM.from_pretrained(model_name).cuda()
        ...
        model = LlavaLlamaImageBindSelectAllForCausalLM.from_pretrained(model_name, torch_dtype=torch.float16).cuda()
    ...
    for i, line in enumerate(tqdm(questions)):
        ...
        if 'coco/val2014' in args.image_folder:
        ...
        if args.conv_mode not in ['vicuna_v1_1', 'llava_v1']:
            try:
