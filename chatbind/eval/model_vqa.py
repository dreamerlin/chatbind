...
from chatbind import LlavaLlamaImageBindSelectForCausalLM
...
def eval_model(args):
    ...
    if args.mm_projector is None:
        ...
        model = LlavaLlamaImageBindSelectForCausalLM.from_pretrained(model_name, torch_dtype=torch.float16).cuda()
